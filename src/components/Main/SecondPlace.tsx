...
const SecondPlace: React.FC<FirstPlaceProps> = ({
  top,
  right,
  left,
  bottom,
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center bg-gray-300 text-[#121236] py-1.5 px-3 rounded-xl space-x-2">
        <span className="font-bold opacity-35">#2</span>
