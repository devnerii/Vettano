...
const FirstPlace: React.FC<FirstPlaceProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center bg-yellow-400 text-[#121236] py-0.5 sm:py-1 md:py-1 lg:py-2 xl:py-2.5 2xl:py-3 px-1 sm:px-2.5 md:px-2 lg:px-3.5 xl:px-4 2xl:px-4.5 rounded-xl space-x-0.5 sm:space-x-1 md:space-x-1.5 lg:space-x-2 xl:space-x-2.5 2xl:space-x-3">
