...
const LeftColumn: React.FC = () => {
  ...
  return (
    <SlideInAnimation
      duration={1}
      initialX={-100}
      className="fixed top-0 left-0 w-full md:w-1/3 lg:w-1/4 xl:w-1/5 h-screen bg-gradient-to-b from-[#1d1c49] to-[#0f0e29] z-50 flex flex-col items-start pl-4 overflow-y-scroll overflow-x-hidden custom-scrollbar mt-8 pb-8"  // Adicionando pb-8 para padding-bottom
    >
